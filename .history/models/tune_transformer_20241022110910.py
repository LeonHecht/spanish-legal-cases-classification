...
def run(model_checkpoint, num_labels,
    ...
    if read_datasets:
        ...
        train_dataset = load_from_disk("datasets/train_dataset_google")
        val_dataset = load_from_disk("datasets/val_dataset_google")
        test_dataset = load_from_disk("datasets/test_dataset_google")
    else:
